    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4 animate-in fade-in duration-200">
      <div className="bg-white dark:bg-slate-800 rounded-xl max-w-sm w-full p-6 shadow-2xl relative">
        ...
        <div className="flex items-center space-x-3 mb-4">
          <div
            className={`p-2 rounded-lg ${destructive
        ...
        <div className="flex space-x-3 justify-end">
          ...
          <button
            onClick={onConfirm}
            disabled={pending}
            className={`px-4 py-2 font-medium text-white rounded-lg disabled:opacity-50 flex items-center space-x-2 transition-colors ${destructive
